...
public class PolarPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = findViewById(R.id.polar_one);
        btn2 = findViewById(R.id.polar_two);
        btn3 = findViewById(R.id.polar_three);
        btn4 = findViewById(R.id.polar_four);
        ...
        pandaButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PolarPage.this, PandaPage.class));
            }
        });
